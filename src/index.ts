 ...
 *
 * This is the main public API surface entry point providing the BridgeClient
 * and related types for chat and streaming functionality.
 *
 * @example
 * ```typescript
 * import { BridgeClient } from "@llm-bridge/library";
 *
...
// TODO: Export createClient factory function when implemented (Phase 1)
