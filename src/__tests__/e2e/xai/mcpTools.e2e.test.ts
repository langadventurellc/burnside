...
describe("xAI MCP Tool Basic Validation E2E", () => {
  ...
  beforeAll(async () => {
    ...
    const { XAIV1Provider } = await import(
      "../../../providers/xai-v1/xaiV1Provider"
    );
